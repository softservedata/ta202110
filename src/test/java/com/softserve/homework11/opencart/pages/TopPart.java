...
import com.softserve.homework11.opencart.data.Currencies;
...
public abstract class TopPart {
    ...
    private void initElements() {
        // init elements
        currency = driver.findElement(By.cssSelector("button.btn-link.dropdown-toggle"));
    ...
    private DropdownComponent createDropdownComponent() {
    	dropdownComponent = new DropdownComponent(driver);
        return getDropdownComponent();
    }

    private void clickDropdownComponentEuro() {
        getDropdownComponent().clickEuro();
        dropdownComponent = null;
    }

    private void clickDropdownComponentPound() {
        getDropdownComponent().clickPound();
        dropdownComponent = null;
    }

    private void clickDropdownComponentDollar() {
        getDropdownComponent().clickDollar();
        dropdownComponent = null;
    }
