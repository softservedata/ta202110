...
import com.softserve.homework11.opencart.pages.DropdownComponent;
...
public class CurrencyTest extends TestRunner {
    ...
    public void checkCurrency(Currencies currency) {
        ...
        HomePage homePage = loadApplication()
        		.gotoHomePage();
        String oldPrice = homePage.getPriceMacBookText();
        ...
        Assert.assertNotEquals(oldPrice, homePageReload.getPriceMacBookText());
    	presentationSleep();
    }
