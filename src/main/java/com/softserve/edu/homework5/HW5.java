...
public class HW5 {
    ...
    public void loginTest() {
        ...
        driver.findElement(By.cssSelector("a[href='http://taqc-opencart.epizy.com/index.php?route=account/login']")).click();
        ...
        Assert.assertTrue(driver.findElement(By.cssSelector("#content > h2:nth-child(1)")).isDisplayed());
